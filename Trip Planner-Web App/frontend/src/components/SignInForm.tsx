    ...
    <div className="">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      className="border-[#3CACAE] rounded-full border-[1px]"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      type="password"
                      className="border-[#3CACAE] marker:text-lightblu rounded-full border-[1px]"
                    />
                  </FormControl>
                  <FormMessage/>
                </FormItem>
          ...
          {/*  SUBMIT BUTTON  */}
          <Button
            className="bg-[#3CACAE] w-full rounded-full hover:bg-[#C26DBC]"
            type="submit"
          >
            Sign in
          </Button>
